...
class McpClient {
  ...
  Future<void> connectToServer(
    ...
    print("McpClient [$serverId]: Connecting: $command ${args.join(' ')}");
    ...
    try {
      ...
      _transport!.onclose = () {
        ...
        print("MCP Transport closed unexpectedly [$serverId].");
        _isConnected = false;
      ...
      print("McpClient [$serverId]: Failed to connect: $e");
      _isConnected = false;
  ...
  Future<void> _fetchTools() async {
    ...
    print("McpClient [$serverId]: Fetching tools...");
    try {
      ...
      _tools = fetchedTools;
      print("McpClient [$serverId]: Discovered ${_tools.length} tools.");
    } catch (e) {
      print("McpClient [$serverId]: Failed to fetch MCP tools: $e");
  ...
  Future<CallToolResult> callTool(
    ...
    try {
      ...
      print("McpClient [$serverId]: Error calling tool '$toolName': $e");
  ...
  Future<void> cleanup() async {
    ...
    if (_transport != null) {
      print("McpClient [$serverId]: Cleaning up transport...");
      ...
      try {
        ...
        print("McpClient [$serverId]: Transport closed successfully.");
      } catch (e) {
        print(
